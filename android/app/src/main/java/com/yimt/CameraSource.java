...
public class CameraSource {
  ...
  private final com.yimt.GraphicOverlay graphicOverlay;
  ...
  private com.yimt.VisionImageProcessor frameProcessor;
  ...
  public CameraSource(Activity activity, com.yimt.GraphicOverlay overlay) {
  ...
  public void setMachineLearningFrameProcessor(com.yimt.VisionImageProcessor processor) {
    synchronized (processorLock) {
      cleanScreen();
      if (frameProcessor != null) {
        frameProcessor.stop();
