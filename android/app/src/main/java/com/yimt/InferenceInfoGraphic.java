...
public class InferenceInfoGraphic extends com.yimt.GraphicOverlay.Graphic {

  private static final int TEXT_COLOR = Color.WHITE;
  private static final float TEXT_SIZE = 60.0f;

  private final Paint textPaint;
  private final com.yimt.GraphicOverlay overlay;
  ...
  public InferenceInfoGraphic(
      com.yimt.GraphicOverlay overlay,
      long frameLatency,
  ...
  public InferenceInfoGraphic(com.yimt.GraphicOverlay overlay) {
